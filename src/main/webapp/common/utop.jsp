    ...
    <div class="width1200 center_yh font14 c_66" style="height: 25px;line-height: 25px;">
        ...
        <div class="right_yh" id="fast_jump">
            <c:if test="${userId!=null}">
                ...
                <b></b>
                <a href="${ctx}/car/queryCar">我的购物车</a>
                <b></b>
            </c:if>
            <c:if test="${userId==null}">
...
<div class="width100 hidden_yh">
    <div class="width1200 center_yh hidden_yh">
        <a href="#" class="block_yh left_yh">
            <img src="${ctx}/static/images/logo.png" alt="" style="height: 70px">
        </a>
        <div class="right_yh" style="height:28px;width:316px;border:2px solid #dd4545;margin-top:-40px;">
            <form action="${ctx}/item/shopList" method="post">
                <input type="text" placeholder="请输入商品的名字" class="search" name="condition" value="${condition}">
