...
<div class="width100" style="height: 45px;background: #dd4545;margin-top: 40px;position: relative;z-index: 100;">
    ...
    <div class="width1200 center_yh relative_yh" style="height: 45px;">
        ...
        <div class="left_yh Selected" style="width: 230px;height: 45px;" id="hiddenShow">
            <!--头部的图标-->
            <img src="${ctx}/static/user/images/cd.png" class="left_yh" style="margin-left: 24px;" alt="">
            ...
            <div class="downSlide">
                <c:forEach items="${lbs}" var="data" varStatus="l">
                    <div class="n1Nav">
                        ...
                        <img src="${ctx}/static/user/images/jt.png" alt="">
                        <div class="n2Nav">
                            <div class="n3Nav">
...
<div class="width1200 center_yh hidden_yh" style="position: relative;z-index:80;">
    <div class="example2" style="width: 1200px;height: 490px;overflow: hidden;margin-left: 230px;">
        <ul>
            <li><img src="${ctx}/static/images/a.webp" alt=""></li>
            <li><img src="${ctx}/static/images/b.webp" alt=""></li>
            <li><img src="${ctx}/static/images/c.webp" alt=""></li>
            <li><img src="${ctx}/static/images/d.webp" alt=""></li>
        </ul>
    </div>
    <script>
        $(function () {
