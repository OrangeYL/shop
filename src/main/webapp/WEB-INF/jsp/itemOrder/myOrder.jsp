...
<div class="width100 hidden_yh" style="background: #f0f0f0;padding-top: 34px;padding-bottom: 34px;">
    <div class="width1200 hidden_yh center_yh">
        <div id="vipNav">
            ...
            <a href="${ctx}/collect/queryCollectPage">商品收藏</a>
                        ...
                        <div class="width100 hidden_yh">
                            ...
                            <c:forEach items="${data.details}" var="chil" varStatus="l">
                                <div style="width: 838px;border-bottom: 1px dashed #ddd;padding-top: 30px;padding-bottom: 30px;" class="hidden_yh center_yh">
                                    ...
                                    <div class="left_yh" style="width: 580px;">
                                        ...
                                        <p class="c_66 font16" style="margin-top: 16px;">折扣：${chil.item.discount}</p>
                                        <p class="red" style="margin-top: 10px;">￥${chil.item.price}</p>
                                    </div>
                                    <div class="right_yh">
                                        <c:if test="${data.status==3}">
                                            <a href="${ctx}/itemOrder/appraise?id=${chil.itemId}" class="onfff block_yh tcenter font16 onHoverr" style="margin-top: 10px;padding-right: 6px;">
                                                去评价
                                            </a>
                                        </c:if>
                                    </div>
                            ...
                            <div style="width: 838px;padding-top:30px;padding-bottom: 30px;" class="hidden_yh center_yh tleft">
                                ...
                                <c:if test="${data.status==0}">
                                    <a href="${ctx}/itemOrder/cancel?id=${data.id}" class="c_33 onHover font20 onorange right_yh" style="margin-top: 10px;padding-right: 6px;">
                                        取消订单
                                    </a>
                                </c:if>
                                ...
                                <c:if test="${data.status==2}">
                                    <a href="${ctx}/itemOrder/receipt?id=${data.id}" class="c_33 onHover font20 onorange right_yh" style="margin-top: 10px;padding-right: 6px;">
                                        去收货
                                    </a>
                                </c:if>
                                <c:if test="${data.status==3}">
